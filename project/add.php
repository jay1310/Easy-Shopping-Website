<html>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-7">
                <form action="scripts/addScript.php" method="post" enctype="multipart/form-data">
                    <table class="table">
                        <tr><th colspan=2><center><h2><b>Add Product</b></h2></center></th></tr>
                        <tr><th><h4><b>
                                Section: 
                            </b></h4></th>
                        ...
                        <tr><td><input class="btn btn-lg btn-primary" type="submit" value="Add Product"></td></tr>
                    </table>
